defmodule UniversalProxy.MixProject do
  ...
  defp deps do
    [
      ...
      # Custom Nerves systems with BlueZ + D-Bus (kernel BT serdev/btusb +
      # btbcm/rtl_bt firmware, dbus, bluez5-utils) for the Bluetooth proxy on
      # all BT-capable Pis. Prebuilt artifacts are pulled from the releases
      # repo; no local buildroot required (host must be linux/x86_64).
      # Upstream systems lack the BT userspace.
      {:nerves_system_rpi0,
